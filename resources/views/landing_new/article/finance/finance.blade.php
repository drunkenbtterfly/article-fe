...
<body>
    ...
    <nav class="p-2 bg-[#E180FF]">
      <div class="flex justify-center items-center">
        <ul class="flex space-x-[70px] text-2xl text-white font-bold">
          ...
          <li class="text-blue-600 hover:text-blue-600"><a href="/finance">Finance</a></li>
  ...
  <div class="container mx-auto flex flex-col lg:flex-row p-20 gap-20">
    ...
    <div class="lg:w-2/3 lg:order-first flex flex-col lg:flex-row justify-center my-5">
      <div class="bg-[#EDEDED] h-[587px] rounded-l-[25px] shadow-xl overflow-hidden lg:w-2/3">
          <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/48wPTHP/Screenshot-2024-03-13-221408.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-96">
                  ...
                  <p class="bg-black p-4 text-white text-lg font-semibold absolute bottom-36 left-4 py-5 px-5 rounded-xl">Finance</p>
      ...
      <div class="bg-[#EDEDED] h-[587px] rounded-r-[25px] shadow-xl overflow-hidden lg:w-1/3">
          <div class="grid grid-rows-3 h-full">
            <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/sRMqt4W/Screenshot-2024-03-13-221523.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-40">
                  <!-- Additional content inside the gradient overlay if needed -->
                  <p class="bg-black text-white text-sm font-semibold absolute bottom-20 left-4 py-5 px-5 rounded-xl">Finance</p>
            ...
            <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/Q6219gR/Screenshot-2024-03-13-221607.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-40">
                <!-- Additional content inside the gradient overlay if needed -->
                <p class="bg-black text-white text-sm font-semibold absolute bottom-20 left-4 py-5 px-5 rounded-xl">Finance</p>
                  <p class="text-white text-sm absolute bottom-4 left-4 ">Lorem ipsum dolor sit amet consectetur. Venenatis pharetra nulla lobortis risus praesent</p>
            ...
            <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/5cmvjGG/Screenshot-2024-03-13-221647.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-40">
              <!-- Additional content inside the gradient overlay if needed -->
              <p class="bg-black text-white text-sm font-semibold absolute bottom-20 left-4 py-5 px-5 rounded-xl">Finance</p>
                  <p class="text-white text-sm absolute bottom-4 left-4 ">Lorem ipsum dolor sit amet consectetur. Venenatis pharetra nulla lobortis risus praesent</p>
    ...
    <div class="lg:w-1/3">
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          <div class="bg-[#E180FF] flex justify-center items-center text-white font-bold text-2xl h-20 rounded-t-[20px] p-2">Terpopuler</div>
          <div class="grid grid-rows-5 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-center text-xl text-[#E180FF] font-bold">Terpopuler lainnya</div>
          </div>
        </div>
      </div> 
  </div>
  ...
  <footer class="mt-20 bg-gradient-to-br from-slate-50 to-[#E180FF]">
