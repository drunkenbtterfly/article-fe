...
<body>
    ...
    <nav class="p-2 bg-[#FB88B4]">
      <div class="flex justify-center items-center">
        <ul class="flex space-x-[70px] text-2xl text-white font-bold">
          ...
          <li class="text-blue-600 hover:text-blue-600"><a href="automotive.html">Automotive</a></li>
    ...
    <div class="lg:w-1/3">
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          ...
          <div class="grid grid-rows-5 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-center text-xl text-[#FB88B4] font-bold">Terpopuler lainnya</div>
          </div>
        </div>
      </div> 
  </div>
  ...
  <footer class="mt-20 bg-gradient-to-br from-slate-50 to-[#FB88B4]">
