...
<header>
  ...
  <div class="container flex flex-wrap">
        ...
        <?php foreach ($berita as $item) : ?>
            ...
            <span class="flex justify-center text-yellow-500 font-bold"><?php echo $item['penulis']; ?></span>
            ...
            <div class="h-20 w-full bg-[#D9D9D9] rounded-xl overflow-hidden my-2">
              <div class="flex flex-col justify-center p-4">
                <h2 class="text-[#F3B95F] font-bold">Baca juga</h2>
        ...
        <div>
            ...
            <div class="flex gap-5 py-2">
                <div class="bg-yellow-500 text-white rounded-lg shadow-xl p-1">#Food</div>
                <div class="bg-yellow-500 text-white rounded-lg shadow-xl p-1">#Kuliner</div>
                <div class="bg-yellow-500 text-white rounded-lg shadow-xl p-1">#Makanan</div>
            </div>
        </div>
        </div>
        ...
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          <div class="bg-[#F3B95F] flex justify-center items-center text-white font-bold text-2xl h-20 rounded-t-[20px] p-2">Terpopuler</div>
          <div class="grid grid-rows-8 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-start text-xl text-[#F3B95F] font-bold mb-10">Terpopuler lainnya</div>
          </div>
        </div>
