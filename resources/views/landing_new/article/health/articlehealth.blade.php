...
<header>
  ...
  <div class="container flex flex-wrap">
        ...
        <?php foreach ($berita as $item) : ?>
            ...
            <span class="flex justify-center text-[#5375F0] font-bold"><?php echo $item['penulis']; ?></span>
            ...
            <div class="h-20 w-full bg-[#D9D9D9] rounded-xl overflow-hidden my-2">
              <div class="flex flex-col justify-center p-4">
                <h2 class="text-[#5375F0] font-bold">Baca juga</h2>
        ...
        <div>
            ...
            <div class="flex gap-5 py-2">
                <div class="bg-[#5375F0] text-white rounded-lg shadow-xl p-1">#Health</div>
                <div class="bg-[#5375F0] text-white rounded-lg shadow-xl p-1">#Cancer</div>
                <div class="bg-[#5375F0] text-white rounded-lg shadow-xl p-1">#Herbal</div>
            </div>
        </div>
        </div>
        ...
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          ...
          <div class="grid grid-rows-8 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-start text-xl text-[#5375F0] font-bold mb-10">Terpopuler lainnya</div>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-10">
          <div class="flex items-start">
            ...
            <div class="flex flex-col p-2">
              ...
              <span class="mt-2 mb-2 font-bold text-[#5375F0]">Health</span>
