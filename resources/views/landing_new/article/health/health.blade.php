...
<body>
    ...
    <nav class="p-2 bg-[#5375F0]">
      <div class="flex justify-center items-center">
        <ul class="flex space-x-[70px] text-2xl text-white font-bold">
          ...
          <li class="text-blue-600 hover:text-blue-600"><a href="/healt">Healt</a></li>
  ...
  <div class="container mx-auto flex flex-col lg:flex-row p-20 gap-20">
      ...
      <div class="bg-[#EDEDED] h-[587px] rounded-[25px] shadow-xl">
        <div class="flex flex-row relative">
          <div class="bg-black h-[314px] w-full rounded-t-[15px] relative">
              <img src="https://i.ibb.co/qBfjxCv/Screenshot-2024-03-13-220632.png" alt="Deskripsi Gambar" class="w-full h-full object-cover rounded-t-[15px]">
              <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-[#5375F0]"></div>
      ...
      <div class="flex">
        <div class="h-[273px] rounded-bl-[15px] w-1/3 overflow-hidden">
            <div class="h-full w-full relative">
                <img src="https://i.ibb.co/8j532Kg/Screenshot-2024-03-13-221121.png" alt="Deskripsi Gambar" class="w-full h-full rounded-bl-[15px] object-cover">
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-[#5375F0]"></div>
                <div class="absolute top-0 left-0 w-full h-full flex items-end justify-start p-5 text-white">
        ...
        <div class=" h-[273px] bg-green-300 w-1/3 overflow-hidden">
            <div class="h-full w-full relative">
                <img src="https://i.ibb.co/K64ZPtp/Screenshot-2024-03-13-221206.png" alt="Deskripsi Gambar" class="w-full h-full object-cover">
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-[#5375F0]"></div>
                <div class="absolute top-0 left-0 w-full h-full flex items-end justify-start p-5 text-white">
                    <p>Top 3 Berita Bola: Pesaing Mundur Teratur,</p>
                </div>
        ...
        <div class="bg-red-300 rounded-br-[15px] h-full w-1/3 overflow-hidden">
            <div class="h-[273px] w-full relative">
                <img src="https://i.ibb.co/mBR0CbH/Screenshot-2024-03-13-221246.png" alt="Deskripsi Gambar" class="w-full h-full rounded-br-[15px] object-cover">
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-[#5375F0]"></div>
                <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-end p-5 text-white">
                  <span class="bg-black p-2 w-[55px]  rounded-xl mb-2 items-start">Health</span>  
    ...
    <div class="lg:w-1/3">
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          <div class="bg-[#5375F0] flex justify-center items-center text-white font-bold text-2xl h-20 rounded-t-[20px] p-2">Terpopuler</div>
          <div class="grid grid-rows-5 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-center text-xl text-[#5375F0] font-bold">Terpopuler lainnya</div>
          </div>
        </div>
      </div> 
  </div>
  ...
  <div class="grid grid-cols-4 gap-10 p-20">
      ...
      <div class="flex flex-row relative">
        <div class="bg-black h-[364px] w-full rounded-[15px] relative overflow-hidden">
          <img src="https://i.ibb.co/qBfjxCv/Screenshot-2024-03-13-220632.png" alt="Deskripsi Gambar" class="w-full h-full object-cover rounded-[15px]">
  ...
  <footer class="mt-20 bg-gradient-to-br from-slate-50 to-[#5375F0]">
