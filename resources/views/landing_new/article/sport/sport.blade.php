...
<body>
      ...
      <div class="bg-[#EDEDED] h-[587px] rounded-[25px] shadow-xl">
        <div class="flex flex-row relative">
          <div class="bg-black h-[314px] w-full rounded-t-[15px] relative">
              ...
              <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-[#3DD1AE]"></div>
    ...
    <div class="lg:w-1/3">
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          ...
          <div class="grid grid-rows-5 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-center text-xl text-[#3DD1AE] font-bold">Terpopuler lainnya</div>
          </div>
        </div>
      </div> 
  </div>
  ...
  <div class="flex justify-start items-start p-10">
    <div class="bg-[#3DD1AE] h-10 w-5"></div>
  ...
  <footer class="mt-20 bg-gradient-to-br from-slate-50 to-[#3DD1AE]">
