...
<body>
    ...
    <nav class="p-2 bg-[#FF7DE2]">
      <div class="flex justify-center items-center">
        <ul class="flex space-x-[70px] text-2xl text-white font-bold">
          ...
          <li class="text-blue-600 hover:text-blue-600"><a href="/tech">Tech</a></li>
  ...
  <div class="container mx-auto flex flex-col lg:flex-row p-20 gap-20">
    ...
    <div class="lg:w-2/3 lg:order-first flex flex-col lg:flex-row justify-center my-5">
      <div class="bg-[#EDEDED] h-[587px] rounded-l-[25px] shadow-xl overflow-hidden lg:w-2/3">
          <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/v1PBsNy/Screenshot-2024-03-13-222030.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-96">
                  ...
                  <p class="bg-black p-4 text-white text-lg font-semibold absolute bottom-36 left-4 py-5 px-5 rounded-xl">Tech</p>
      ...
      <div class="bg-[#EDEDED] h-[587px] rounded-r-[25px] shadow-xl overflow-hidden lg:w-1/3">
          <div class="grid grid-rows-3 h-full">
            <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/2jcLkr9/Screenshot-2024-03-13-222121.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-40">
                  <!-- Additional content inside the gradient overlay if needed -->
                  <p class="bg-black text-white text-sm font-semibold absolute bottom-20 left-4 py-5 px-5 rounded-xl">Tech</p>
            ...
            <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/KDb3QKY/Screenshot-2024-03-13-222203.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-40">
                <!-- Additional content inside the gradient overlay if needed -->
                <p class="bg-black text-white text-sm font-semibold absolute bottom-20 left-4 py-5 px-5 rounded-xl">Tech</p>
                  <p class="text-white text-sm absolute bottom-4 left-4 ">Lorem ipsum dolor sit amet consectetur. Venenatis pharetra nulla lobortis risus praesent</p>
            ...
            <div class="relative h-full w-full bg-black">
              <img src="https://i.ibb.co/y841fSP/Screenshot-2024-03-13-222302.png" alt="" class="h-full w-full object-cover">
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#CC7EE4] to-transparent p-4 h-40">
              <!-- Additional content inside the gradient overlay if needed -->
              <p class="bg-black text-white text-sm font-semibold absolute bottom-20 left-4 py-5 px-5 rounded-xl">Tech</p>
                  <p class="text-white text-sm absolute bottom-4 left-4 ">Lorem ipsum dolor sit amet consectetur. Venenatis pharetra nulla lobortis risus praesent</p>
    ...
    <div class="lg:w-1/3">
        <div class="bg-[#EDEDED] h-auto shadow-xl border-2 border-gray-200 rounded-[20px]">
          <div class="bg-[#FF7DE2] flex justify-center items-center text-white font-bold text-2xl h-20 rounded-t-[20px] p-2">Terpopuler</div>
          <div class="grid grid-rows-5 grid-flow-col gap-4">
            ...
            <div class="flex justify-center items-center text-xl text-[#FF7DE2] font-bold">Terpopuler lainnya</div>
          </div>
        </div>
      </div> 
  </div>
  ...
  <div class="grid grid-cols-4 gap-10 p-20">
      ...
      <div class="flex flex-row relative">
        <div class="bg-black h-[364px] w-full rounded-[15px] relative overflow-hidden">
          <img src="https://i.ibb.co/v1PBsNy/Screenshot-2024-03-13-222030.png" alt="Deskripsi Gambar" class="w-full h-full object-cover rounded-[15px]">
      ...
      <div class="flex flex-row relative">
        <div class="bg-black h-[364px] w-full rounded-[15px] relative overflow-hidden">
          <img src="https://i.ibb.co/2jcLkr9/Screenshot-2024-03-13-222121.png" alt="Deskripsi Gambar" class="w-full h-full object-cover rounded-[15px]">
          <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-black rounded-[15px]"></div>
          <div class="absolute top-0 left-0 w-full h-full flex items-end justify-start p-5 text-white">
              <p>Ngeri! Resesi Amerika Bakal Terjadi Mulai Kuartal I/2024</p>
          </div>
      ...
      <div class="flex flex-row relative">
        <div class="bg-black h-[364px] w-full rounded-[15px] relative overflow-hidden">
          <img src="https://i.ibb.co/KDb3QKY/Screenshot-2024-03-13-222203.png" alt="Deskripsi Gambar" class="w-full h-full object-cover rounded-[15px]">
          <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-black rounded-[15px]"></div>
          <div class="absolute top-0 left-0 w-full h-full flex items-end justify-start p-5 text-white">
              <p>Ngeri! Resesi Amerika Bakal Terjadi Mulai Kuartal I/2024</p>
          </div>
      ...
      <div class="flex flex-row relative">
        <div class="bg-black h-[364px] w-full rounded-[15px] relative overflow-hidden">
          <img src="https://i.ibb.co/y841fSP/Screenshot-2024-03-13-222302.png" alt="Deskripsi Gambar" class="w-full h-full object-cover rounded-[15px]">
          <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-black rounded-[15px]"></div>
          <div class="absolute top-0 left-0 w-full h-full flex items-end justify-start p-5 text-white">
              <p>Ngeri! Resesi Amerika Bakal Terjadi Mulai Kuartal I/2024</p>
          </div>
  ...
  <footer class="mt-20 bg-gradient-to-br from-slate-50 to-[#FF7DE2]">
